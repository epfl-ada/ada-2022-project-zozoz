...
def select_next_feature(regression_df: pd.DataFrame, target: pd.Series, binary_target: pd.Series,
...
def forward_selection(regression_df: pd.DataFrame, target: pd.Series, binary_target: pd.Series,
    ...
    while ((len(ignored_features) + len(current_features)) < len(regression_df)
        ...
        last_feature = select_next_feature(regression_df, target, binary_target,
